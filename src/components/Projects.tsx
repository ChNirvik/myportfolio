                                                ...
                                                <div className="h-48 w-full relative bg-gray-900 flex items-center justify-center p-4">
                                                    {file.type === 'image' ? (
                                                        ...
                                                        <div className="text-center group-hover:scale-105 transition-transform duration-300">
                                                            <svg className={`w-16 h-16 mx-auto mb-2 ${file.type === 'pdf' ? 'text-red-400' : file.type === 'doc' ? 'text-blue-400' : file.type === 'gdrive' ? 'text-green-500' : 'text-gray-400'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                                {file.type === 'pdf' ? (
                                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
                                                                ) : file.type === 'doc' ? (
                                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                                                ) : file.type === 'gdrive' ? (
                                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 2L2 22h20L12 2zm0 4.5l6.5 13.5H5.5L12 6.5z" />
                                                                ) : (
                                                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
                                                                )}
                                                            </svg>
                                                            <span className="text-gray-400 text-sm font-medium">
                                                                {file.type === 'pdf' ? 'PDF Document' : file.type === 'doc' ? 'Word Document' : file.type === 'gdrive' ? 'Google Drive Folder' : 'Document'}
                                                            </span>
                                                        </div>
                                                    )}
                                                </div>
